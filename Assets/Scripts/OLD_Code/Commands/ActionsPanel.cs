...
public class ActionsPanel : MonoBehaviour
{
    ...
    public void OpenMenus(int layer, MenuItem item)
    {
        ...
        {
            _itemL3 = item;
            RerenderPanel(Panel4, item.childNodes, layer);
            Panel1.gameObject.SetActive(true);
            Panel2.gameObject.SetActive(true);
            Panel3.gameObject.SetActive(true);
    ...
    public void OLD_OpenMenus(int layer, MenuItem item)
    {
        if (layer == 2)
        {
            _itemL1 = item;
    ...
    public void CloseMenus()
    {
        ...
        foreach (Transform obj in Panel4)
        {
            Destroy(obj.gameObject);
        }
    ...
    private void OpenBlock(MenuItem item)
    {
        ...
        if (item.childNodes == null || item.childNodes.Length == 0 || item == _itemL3) 
            CloseMenus();
    }
